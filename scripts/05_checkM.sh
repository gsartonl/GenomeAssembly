...
checkm lineage_wf -t 24 --tab_table -f ${outDir}/CheckM_QC_${LIBRARY}.tsv --aai_strain 0.95 ${assembly} ${outDir}
...
checkm coding_plot ${out} ${bin} ${plt} -x fasta 95
checkm nx_plot ${bin} ${plt} -x fasta
